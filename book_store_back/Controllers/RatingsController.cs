...
namespace book_store_back.Controllers
{
    ...
    public class RatingsController : ControllerBase
    {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<IActionResult> PostRating(int userId, int bookId, int score)
        {
            // Перевірка чи score входить в допустимий діапазон від 1 до 10
            if (score < 1 || score > 10)
            {
            ...
            // Перевірка чи існує книга з таким bookId
            ...
            // Додавання рейтингу до бази даних
