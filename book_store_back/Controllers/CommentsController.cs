...
namespace book_store_back.Controllers
{
    ...
    public class CommentsController : ControllerBase
    {
        ...
        [HttpGet("Book/{bookId}")]
        public async Task<ActionResult<IEnumerable<Comment>>> GetCommentsByBookId(int bookId)
        {
            ...
            // Отримуємо коментарі до книги, сортуємо за датою публікації (найновіші першими)
